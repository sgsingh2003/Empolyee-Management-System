...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            String EISMANno = lblEISMANno.getText();
            
            try {
                Conn conn = new Conn();
                String query = "insert into employee1 values('"+name+"', '"+fname+"', '"+dob+"', '"+salary+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+designation+"', '"+aadhar+"', '"+EISMANno+"')";
